# Polymorph UI — GitHub Issue Roadmap

Use case: **Self-Pacing Complex Documentation Reader**

Misty owns only the front-loaded foundation and final submission issues. No Sunday or Monday engineering dependency should block on her.

## Execution order

| Order | Suggested owner | Target | Issue |
|---:|---|---|---|
| 1 | Misty | Saturday, July 18, 2026 at 12:00 PM Central | foundation: scaffold the MVP and repository standards |
| 2 | Vanessa | Saturday, July 18, 2026 | content-ui: build the dense documentation lesson and baseline reader |
| 3 | Ed | Sunday, July 19, 2026 | telemetry: implement privacy-safe reading-friction signals |
| 4 | Ed with Dante review | Sunday, July 19, 2026 | engine: implement deterministic friction scoring and reason codes |
| 5 | Dante | Sunday, July 19, 2026 | ai: build the GPT-5.6 structured adaptation endpoint |
| 6 | Vanessa | Sunday, July 19, 2026 | ui: implement the controlled adaptive component registry |
| 7 | Dante and Vanessa | Monday, July 20, 2026 | integration: connect telemetry, classification, AI, and UI recovery |
| 8 | Ed with Vanessa support | Monday, July 20, 2026 evening | quality: verify accessibility, privacy, fallback, tests, and deployment |
| 9 | Misty with Vanessa backup | Tuesday, July 21, 2026 | submission: finalize README, Codex evidence, demo script, and Devpost package |

---

## Issue 1: foundation: scaffold the MVP and repository standards

**Suggested owner:** Misty

**Target:** Saturday, July 18, 2026 at 12:00 PM Central
...
## Issue 2: content-ui: build the dense documentation lesson and baseline reader

**Suggested owner:** Vanessa

**Target:** Saturday, July 18, 2026
...
## Issue 3: telemetry: implement privacy-safe reading-friction signals

**Suggested owner:** Ed

**Target:** Sunday, July 19, 2026

**Dependencies:** #1 and the section contract from #2
...
## Issue 4: engine: implement deterministic friction scoring and reason codes

**Suggested owner:** Ed with Dante review
...
## Issue 5: ai: build the GPT-5.6 structured adaptation endpoint

**Suggested owner:** Dante

**Target:** Sunday, July 19, 2026

**Dependencies:** #1 and shared contracts
...
## Issue 6: ui: implement the controlled adaptive component registry

**Suggested owner:** Vanessa

**Target:** Sunday, July 19, 2026

**Dependencies:** #2 and the AdaptationPlan contract from #5
...
## Issue 7: integration: connect telemetry, classification, AI, and UI recovery

**Suggested owner:** Dante and Vanessa

**Target:** Monday, July 20, 2026

**Dependencies:** #2, #3, #4, #5, and #6
...
## Issue 8: quality: verify accessibility, privacy, fallback, tests, and deployment

**Suggested owner:** Ed with Vanessa support

**Target:** Monday, July 20, 2026 evening
...
## Issue 9: submission: finalize README, Codex evidence, demo script, and Devpost package

**Suggested owner:** Misty with Vanessa backup

**Target:** Tuesday, July 21, 2026
